...
public class CuentaCarasDados {
	...
	public static void main(String[] args) {
		...
		//Buscamos que cara salió más veces
		int maximo=caras[0];
		int indice_caras=0;
		for(int i=1; i<caras.length; i++) {
			if(caras[i]>maximo) {
				indice_caras=i;
				maximo=caras[i];
			}
		...
		System.out.println("La cara que cayó más veces fue " + (indice_caras+1) + " con " + maximo + " de frecuencia");
